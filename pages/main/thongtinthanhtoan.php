 	...
 	?>
  	...
  	<div class="col-md-8">
		  ...
		  ?>
		   <tr>
		    <td colspan="8">
		    	<h2 style="float: left;">Tổng tiền: <?php echo number_format($tongtien,0,',','.').'vnđ' ?></h2><br/>
  	...
  	<div class="col-md-4 hinhthucthanhtoan">
		...
		<input type="submit" value="Thanh toán tiền mặt" name="redirect" class="btn btn-danger">
